...
//           From design and engineering to execution and management, we deliver integrated solutions that shape industries and build a stronger future.
//         </p>
//       </div>
...
//                     <h2 className="text-2xl md:text-3xl font-semibold leading-tight">{TABS[active].headline}</h2>
//                     <p className="mt-4 text-sm md:text-[15px] text-gray-200">{TABS[active].body}</p>
//                     <button
