...
// //   return (
// //     <section className="w-full bg-gray-50 py-12 px-6  md:px-25 lg:px-28">
...
// //               />
// //             </div>
// //             {/* Row 2: Phone | Location | Project Type | Required Capacity */}
...
// //                 className="w-full border-b border-gray-400 py-2 px-3 focus:outline-none focus:border-[#8080FF] resize-none"
// //                 rows={4}
// //               />
// //             </div>
// //             <div className="md:col-span-3 flex items-end">
// //               <button className="px-6 py-3 w-full rounded-full border border-[#000080] text-black font-medium flex items-center justify-center gap-2 hover:bg-black  hover:border-black hover:text-white transition">
// //                 Submit Inquiry →
// //               </button>
// //             </div>
// //           </div>
