  ...
  const slides = [
    {
      ...
      desc: "Delivering end-to-end industrial solutions — from concept design and engineering to installation and commissioning. Our turnkey approach ensures seamless project execution, optimized performance, and on-time delivery across manufacturing, energy, and infrastructure sectors.",
