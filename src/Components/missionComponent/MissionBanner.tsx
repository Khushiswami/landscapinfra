    ...
    <section className="relative w-full">
      ...
      >
        ...
        <div className="bg-[#F4F6F8] p-6 rounded-xl flex flex-col items-center text-center hover:shadow-lg transition">
          <div className="w-20 h-20 flex items-center justify-center rounded-full bg-[#000080] text-white text-4xl mb-4 shadow-md">
            <FaBullseye />
          </div>
        ...
        <div className="col-span-2 bg-[#F4F6F8] p-6 rounded-xl">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            capable of harmonizing product, nature and life. Since our
            inception, and at every stage in{" "}
            <a href="#" className="text-blue-600 font-medium hover:underline">
              our history
            </a>
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            the ride. Our purpose is driven by <strong>our people</strong> and
            the <strong className="font-bold">passion</strong> they demonstrate.
            It gives meaning to our daily work. It drives a shared mindset and
          ...
          <div className="relative h-[300px] md:h-[350px] w-full">
            ...
            <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-center px-4">
              ...
              <p className="text-white max-w-2xl mb-6">
                ...
                vision of addressing the globe’s major challenges and helping
                our customers transform how they operate.
              </p>
              <a
                href="#"
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              The <strong>3DEXPERIENCE Lab</strong> shapes a new framework of
              open innovation, merging collective intelligence with
              collaboration to foster entrepreneurship as well as to strengthen
              society’s future of creation.
            </p>
            <a
              href="#"
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Our <strong>DESIGNStudio</strong> makes innovation happen by
              making available the expertise of 3D innovators who have helped
              companies, small and large, bring their ideas to life through
              Experience Thinking.
            </p>
            <a
              href="#"
