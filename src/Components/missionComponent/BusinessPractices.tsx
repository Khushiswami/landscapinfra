      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid gap-10 md:grid-cols-4 items-start">
          ...
          <div className="md:col-span-1 flex flex-col justify-center text-center md:text-left">
            ...
            <a
              href="#"
              className="inline-block border border-blue-600 text-blue-600 px-6 py-2 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition"
            >
              Read our policies
            </a>
          </div>
            ...
            {policies.map((policy) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <a
                    href={policy.link}
                    className="self-start border border-blue-600 text-blue-600 px-4 py-1.5 rounded-full text-sm font-semibold hover:bg-blue-600 hover:text-white transition"
                  >
                    {policy.btn}
                  </a>
                </div>
