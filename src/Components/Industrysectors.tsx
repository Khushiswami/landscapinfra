...
export default function Industrysector() {
  ...
  return (
    <section className="text-center px-4 sm:px-6 md:px-18 pt-12 md:pt-16 bg-white">
      <section className="w-full py-8 md:pt-16 bg-white relative">
        <div className="mx-auto px-2 sm:px-4 relative">
          <h2 className="text-xl md:text-3xl font-bold text-start text-[#000080] mb-6">
            Sectors
          </h2>
          ...
          {/* Desktop arrows */}
          <div className="custom-prev absolute top-1/2 -translate-y-1/2 left-2 md:-left-12 z-20 cursor-pointer hidden md:flex items-center justify-center rounded-full p-2 md:pl-12">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="custom-next absolute top-1/2 -translate-y-1/2 right-2 md:-right-12 z-20 cursor-pointer hidden md:flex items-center justify-center rounded-full p-2 md:pr-12">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 md:h-8 md:w-9"
              fill="none"
