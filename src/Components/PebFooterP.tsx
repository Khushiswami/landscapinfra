        ...
        <div className="flex flex-col space-y-10 md:flex-row md:space-y-0 md:space-x-8">
          ...
          <div className="md:w-1/3 space-y-4">
            ...
            <p className="text-sm leading-relaxed"> 
              We specialize in engineering, fabrication, and project management for a diverse range of industries, 
              offering a total EPC solution. We hold ISO 9001:2015 and ISO 14001:2015 certifications, 
              with a Pan-India presence and efficient delivery capabilities.
            </p>
          ...
          <div className="md:w-1/3 space-y-4">
            ...
            <ul className="text-sm space-y-2">
              <li className="flex items-center gap-2">
                <FaPhoneAlt /> 
                <a href="tel:+919981813922" className="hover:text-white">+91 9981813922</a>
              </li>
              {/* <li className="flex items-center gap-2">
                <FaEnvelope /> 
