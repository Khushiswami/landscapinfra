...
//   return (
//     <section className="relative w-full sm:h-[180vh] overflow-hidden md:h-[95vh]">
//       {/* Background Video */}
//       <video
...
//   return (
//     // <section className="relative w-full sm:h-[350px] overflow-hidden md:h-[95vh]">
//       // <section className="relative w-full h-[95vh] sm:h-[350px]  overflow-hidden">
// <section className="relative w-full h-[500px] sm:h-[380px] md:h-[99vh] overflow-hidden">
...
//       {/* Bottom Navigation */}
//       <div className="absolute bottom-6 left-0 sm:left-1/2 sm:-translate-x-1/2 w-full px-6 z-10">
//         <div className="flex gap-4 sm:gap-8 justify-start sm:justify-center relative items-center flex-nowrap">
...
//                 {/* Tab Title */}
//                 <p
//                   className={`text-md font-medium text-center min-h-[24px] leading-snug truncate ${
//                     active === realIndex ? "text-white" : "text-gray-300"
//                   }`}
//                   title={s.title}
//                 >
