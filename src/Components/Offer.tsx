...
export default function () {
  ...
  return (
    <div className="mx-auto px-4 sm:px-6 md:px-10 lg:px-16 py-12 ">
      ...
      {/* ✅ Tabs */}
      <div className="flex flex-wrap justify-start md:justify-between gap-2 border-b border-gray-300 mb-8 overflow-x-auto scrollbar-hide">
        {tabs.map((tab, index) => (
          <button
            key={index}
