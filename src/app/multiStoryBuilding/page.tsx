        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 space-y-16">
          ...
          <div className="text-center mx-auto">
            ...
            <p className="text-gray-700 text-lg">
              Landsking Infra offers innovative and dependable prefab
              multi-storey buildings designed for a wide range of applications,
              including office complexes, commercial centers, and institutional
              facilities. Utilizing PUF/EPS insulated panels and Light Gauge
              Steel Framing (LGSF) technology, these structures guarantee
              durability, energy efficiency, and quick installation.
              <br />
              <br />
              Our prefab multi-storey buildings are meticulously engineered with
              key design considerations such as seismic zone compliance, wind
              load resistance, and dead load capacity. We provide end-to-end
              turnkey solutions—from design and manufacturing to on-site
              installation—all seamlessly managed under one roof.
              <br />
              <br />
              Ideal for projects with limited space and tight deadlines, we
              combine PEB and LGSF systems to deliver superior structural
              strength, enhanced by fire-rated coatings that adhere to strict
              safety regulations.
              <br />
              <br />
              With over 20 years of expertise and a strong commitment to fast
              construction, cost-effectiveness, and lasting performance,
              Landsking Infra is a trusted leader in prefab multi-storey
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                With an annual manufacturing capacity exceeding 133,924 MT,
                Landsking Infra is fully equipped to deliver complex,
                large-scale prefabricated buildings across India. Our solutions
                adhere to international standards and can be customized for:
              </p>
