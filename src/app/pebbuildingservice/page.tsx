...
PRE ENGINEERED BUILDINGS            </h2>
            <div className="w-20 h-[3px] bg-[#272727] mt-3 mb-6"></div>

            <p className="text-gray-700 mb-4 leading-relaxed">
             Landsking Infra is your one-stop destination for all building requirements, catering to diverse customer needs. Our pre-engineered steel buildings are uniquely designed and precisely fabricated to suit your specifications. Built in strict adherence to international standards, these buildings consist of meticulously engineered components that are fully compatible with each other.

The fabrication process takes place in state-of-the-art factories under stringent quality control based on detailed shop drawings. Each component is carefully marked, transported to the project site, and assembled as per erection drawings to ensure flawless execution.

We serve industrial, commercial, and institutional sectors with a focus on speed, quality, and reliability. Our buildings are designed for rapid delivery and erection, while offering flexibility for future expansion. Engineered to withstand the harshest weather conditions, Landsking Infra ensures long-lasting, pre-engineered solutions.
            </p>
...
Comprehensive Building Solutions          </h2>
...
PRE ENGINEERED STEEL BUILDINGS            </span>
          </h2>
...
Our Approach to Service
  ...
  <li>
    <span className="font-bold">Systematic Use of Building Families:</span> Ensuring consistency and compatibility across all project components.
  </li>
  <li>
    <span className="font-bold">Comprehensive Detailing:</span> Covering all critical aspects of pre-engineered buildings, from structural elements to cladding and roofing.
  </li>
  <li>
    <span className="font-bold">Geometry Definitions:</span> Highlighting essential structural geometries for accurate fabrication and assembly.
  </li>
  <li>
    <span className="font-bold">Element Visualization:</span> Clearly defining which components need to be displayed for review and construction purposes.
  </li>
  <li>
    <span className="font-bold">Best Practices for Nesting:</span> Optimizing component nesting to reduce material waste and improve manufacturing efficiency.
  </li>
  <li>
    <span className="font-bold">Roof:</span> PUF / EPS insulated sandwich panels of 30 / 40 mm or PPGI roofing sheets.
  </li>
  <li>
    <span className="font-bold">Doors:</span> Insulated doors with all accessories will be provided from our manufacturing setup.
  </li>
  <li>
    <span className="font-bold">Windows:</span> Aluminum anodized sliding windows will be provided from our manufacturing setup.
  </li>
  <li>
    <span className="font-bold">Structure and Accessories:</span> All required supporting accessories and structures will be provided before project delivery.
  </li>
  <li>
    <span className="font-bold">Electrical & Sanitary Fittings:</span> Electrical fittings, sanitary fittings, beds, etc., will be provided as per client requirements and fitted according to the contract.
  </li>
</ul>
