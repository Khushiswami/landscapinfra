    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold leading-snug max-w-4xl mx-auto">
             Pre-Engineered Building Solutions for Sports and Recreation Facilities
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              Landsking Infra delivers comprehensive Pre-Engineered Building (PEB) solutions for sports and leisure facilities, combining durability, functionality, and aesthetic appeal. Whether its stadiums, gymnasiums, indoor sports complexes, or auditoriums, we offer complete services from design and manufacturing to construction, ensuring seamless project execution.
              </p>
              <p className="text-gray-700 mb-4">
               Our PEBs effortlessly blend strong structural integrity with attractive designs, suitable for a wide range of uses including equipment storage and team facilities. Landsking Infra is your reliable partner in delivering world-class sports and leisure infrastructure solutions.
              </p>
      ...
      <section className="bg-gray-50 py-16 px-6 md:px-16 text-center mb-12">
        ...
        <p className="text-gray-700 text-base md:text-lg max-w-4xl mx-auto leading-relaxed">
         Pre-engineered building (PEB) technology has achieved global recognition and is rapidly being embraced by various industries in India. These innovative structures provide resource-efficient and contemporary construction solutions, cutting project durations by as much as 50% compared to conventional methods. Offering cost savings, energy efficiency, and design flexibility, 
         PEBs are revolutionizing the construction sector by meeting tight deadlines and delivering sustainable, high-quality outcomes.
        </p>
      </section>
      <Footer/>
</>
