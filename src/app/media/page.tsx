          ...
          <ul className="space-y-6">
            ...
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800 font-semibold">
                  LandsKingInfra Pvt.Ltd. Prefab Recognised at ISDA’s IIN Awards 2025
                </p>
              </div>
            </li>
            ...
            <li className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800 font-semibold">
                  LandsKingInfra Pvt.Ltd.  Participated In Roof India Exhibition, Mumbai
                  2025–26
                </p>
              </div>
            </li>
