...
const faqs: FAQ[] = [
  ...
  {
    question:
      "What are the main advantages of LGSF construction?",
    answer:
...
Innovative Light Gauge Steel Framing (LGSF) Solutions by Landsking Infra       </h2>
          <div className="w-20 h-[3px] bg-[#272727] mt-3 mb-6"></div>

          <p className="text-gray-700 mb-4 leading-relaxed">
            Landsking Infra is a prominent provider of Light Gauge Steel Framing (LGSF) solutions in India, offering strong, sustainable, and budget-friendly construction options for diverse applications. With a strong foundation in engineering expertise and innovation, we deliver fully tailored
             LGSF systems designed to align with the evolving demands of modern infrastructure.
         </p>
          <h2 className="font-extrabold text-[#000080] leading-snug  ">
What is Light Gauge Steel Framing (LGSF)?      </h2>
          <p className="text-gray-700 mb-4 leading-relaxed">
            Light Gauge Steel Framing (LGSF) is an advanced construction technique that utilizes cold-formed steel components to create structural frameworks for various building types. These components are lightweight, resistant to corrosion, and designed to deliver high speed, durability, 
            and adaptability—making LGSF a perfect fit for modular builds and time-sensitive projects.
          </p>
  ...
  className="rounded-md shadow-md w-[600px] h-[400px] object-cover transform transition duration-500 ease-in-out hover:scale-105 hover:shadow-xl"
        ...
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            <strong>🔧 Accelerated Project Delivery</strong> With components manufactured off-site and assembled quickly on-site, construction timelines are drastically shortened.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            <strong>🏗️ Exceptional Strength & Stability</strong> Steel structures offer superior load-bearing capabilities and perform reliably in seismic zones.
          </p>
             <p className="text-gray-600 leading-relaxed mb-4">
            <strong>🔄 Flexible Design Capabilities</strong>Perfect for intricate architectural styles, curved forms, multi-level buildings, and adaptable layouts.
          </p>
         <p className="text-gray-600 leading-relaxed mb-4">
            <strong>♻️ Environmentally Responsible</strong> Steel is fully recyclable and produces minimal waste, supporting green construction goals.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            <strong>🔥 Built-In Resistance to Fire & Pests</strong>  Steel framing resists termites, rot, warping, and delivers excellent fire protection.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            <strong>💰 Optimized Cost Efficiency</strong>Standardized production and prefabrication reduce both labor expenses and material waste.
          </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        <p className="text-gray-700 leading-relaxed mb-5">
          Landsking Infra provides customized LGSF structures to suit a broad spectrum of industry needs:
        </p>
        <ul>
  <li className= "mb-3"><strong>✅Modern Prefab Villas</strong></li>
  <li className= "mb-3"><strong>✅Show Flats & Marketing Suites</strong></li>
  <li className= "mb-3"><strong>✅On-Site Office Setups</strong></li>
  <li className= "mb-3"><strong>✅Modular Classrooms & Educational Buildings</strong></li>
  <li className= "mb-3"><strong>✅Clinics, Hospitals & Medical Units</strong></li>
  <li className= "mb-3"><strong>✅Staff Housing & Worker Dormitories</strong></li>
  <li className= "mb-3"><strong>✅Commercial Units & Retail Outlets</strong></li>
</ul>
      </div>
    </div>
  </div>
