...
//       <Rndheader />
//       {/* rnd banneer */}
//       <section className="relative w-full h-[30vh] overflow-hidden md:px-17 h-[94vh]">
...
import { useState, useEffect } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Play, Pause, GraduationCap, Users, Lightbulb, Wrench } from "lucide-react";
import { IoIosArrowForward } from "react-icons/io";
import { useRouter } from "next/navigation";
...
export default function Rnd() {
  ...
  const links = [
    { title: "CADFEM Service", subtitle: "SUPPORT & ENGINEERING", icon: <Wrench size={20} />, url: "/service" },
    { title: "Simulation-Trends", subtitle: "DIE ZUKUNFT ENTDECKEN", icon: <Lightbulb size={20} />, url: "/trends" },
    { title: "Studenten-Portal", subtitle: "DEIN GRATIS ANGEBOT", icon: <GraduationCap size={20} />, url: "/students" },
    { title: "Starkes Netzwerk", subtitle: "WELTWEIT SIMULIEREN", icon: <Users size={20} />, url: "/network" },
  ];
