...
import { useState } from "react";import Footer from "yes/Components/Footer";
...
<div className="flex justify-start gap-10 mb-6">
  <div className="flex flex-col items-center">
    <div className="flex flex-col items-center px-8 py-6 bg-[#000080] text-white">
     ...
     <span className="font-medium mt-2 text-center text-xl">Standard Design</span>
  </div>
  ...
  <div className="flex flex-col items-center">
    ...
    <span className="font-medium mt-2 text-center text-xl">Premium Products</span>
  </div>
</div>
          ...
          <div className="flex items-center justify-center bg-[#f2f2f2] px-9 py-12 md:px-19">
            <div className="grid md:grid-cols-2 gap-12  w-full">
              ...
              <div className="flex flex-col items-start justify-center text-blue-700 font-bold">
               <h1 className="text-9xl font-bold text-[#000080]">
05</h1>
                <h2 className="mt-2  font-semibold text-[#000080] text-4xl  md:text-6xl">Fabrication</h2>
              </div>
        ...
        {/* SIZXTH SECT6ION */}
         <div className="flex items-center justify-center bg-[#fff] px-9 py-12 md:px-19">
            ...
            <div className="flex flex-col items-start justify-center text-blue-700 font-bold">
             <h1 className="text-9xl font-bold text-[#000080]">
06</h1>
              <h2 className="mt-2  font-semibold text-[#000080] text-4xl  md:text-6xl">Erection</h2>
            </div>
        ...
        <div className="flex items-center justify-center bg-[#f2f2f2] px-9 py-12 md:px-19">
            ...
            <div className="flex flex-col items-start justify-center text-blue-700 font-bold">
             <h1 className="text-9xl font-bold text-[#000080]">
07</h1>
              <h2 className="mt-2  font-semibold text-[#000080] text-4xl  md:text-6xl">Warranty</h2>
            </div>
